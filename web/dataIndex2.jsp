...
<ul>
  <li><a class="active" href="dataIndex2.jsp">北京典型城区房屋平均租金分析</a></li>
...
<br>
        ...
        <div style="height: 350px; width:380px; float:right; margin-top；250px;" > 
          <br><br><br><br><br><br>
			<span class="gradient-text gradient-text-one">北京典型城区房屋平均租金排名：<br></span> 
			<span class="gradient-text gradient-text-two">东城区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12170.0009元<br></span> 
			<span class="gradient-text gradient-text-two">西城区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9979.1548元<br></span>
			<span class="gradient-text gradient-text-two">朝阳区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4125.8222元<br></span>
			<span class="gradient-text gradient-text-two">大兴区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4051.5873元<br></span>
			<span class="gradient-text gradient-text-two">丰台区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3362.1643元<br></span>
			<span class="gradient-text gradient-text-two">海淀区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3049.5274元<br></span>
		</div>
     ...
     function show() {        
	          $.ajax({
	               type: "GET",
	               url: "/DEMO/AvgzjAction?action=GetAvgzjJson",
	               dataType: "json",  
	               success: function(result){                
	                       ...
	                       pjzydata=[];
	                        for(var i in result){
	                            ...
	                            qy.push(result[i].qy);
	                            pjzydata.push(result[i].pjzydata);   
	                        }
...
option = {
    ...
    series: [{
        name: '平均租金',
        type: 'line',
        data: [9979.1548, 12170.0009, 3049.5274, 4125.8222,4051.5873,3362.1643],
        backgroundStyle: {
