...
<ul>
  ...
  <li><a class="active" href="dataIndex5.jsp">北京市典型城区平均面积租金</a></li>
...
<br>
        ...
        <div style="height: 350px; width:380px; float:right; margin-top；250px;" > 
          <br><br><br><br><br><br>
			<span class="gradient-text gradient-text-one">北京市各区出租房平均面积租金：</span> 
			<span class="gradient-text gradient-text-two">东城区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;西城区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;朝阳区<br></span>
			<span class="gradient-text gradient-text-two">海淀区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;丰台区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大兴区<br></span>  
		</div>
       ...
       function show() {        
  	          $.ajax({
  	               type: "GET",
  	               url: "/DEMO/AvgmjzjAction?action=GetAvgmjzjJson",
  	               dataType: "json",  
  	               success: function(result){               
  	                     ...
  	                     mjzjdata=[];
  	                        for(var i in result){
  	                            ...
  	                            qy.push(result[i].qy);
  	                          mjzjdata.push(result[i].mjzjdata);   
  	                        }
